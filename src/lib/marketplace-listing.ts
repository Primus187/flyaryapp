...
export type MarketErrorCode =
  | PublishProblem | "not_found" | "not_allowed" | "own_listing" | "shop_not_ready" | "already_reported" | "reason_required" | "limit_saved_searches" | "equipment_other_school" | "buyer_not_member" | "school_only" | "banned" | "wrong_status" | "limit_active" | "limit_daily" | "bump_too_soon" | "unknown";
const KNOWN_CODES: readonly string[] = [
  "missing_title", "missing_place", "missing_price", "missing_condition", "missing_attributes", "missing_photo",
  "not_found", "not_allowed", "own_listing", "shop_not_ready", "already_reported", "reason_required", "limit_saved_searches", "equipment_other_school", "buyer_not_member", "school_only", "banned", "wrong_status", "limit_active", "limit_daily", "bump_too_soon",
];
