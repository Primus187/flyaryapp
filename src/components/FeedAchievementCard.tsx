  ...
  return (
    <Card className="border-0 shadow-sm overflow-hidden">
      ...
      <div className="flex items-center gap-3 p-3 pb-2">
        <div className="p-[2px] rounded-full bg-gradient-to-tr from-amber-400 via-yellow-500 to-orange-400">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-sm font-semibold truncate">{achievement.pilot_name}</p>
      ...
      <div className={cn(
        ...
        {/* Shimmer effect for completions */}
        {isComplete && (
      ...
      <CardContent className="p-3 space-y-2">
        <div className="flex items-center gap-3">
          <button onClick={() => onLikeToggle(achievement.id)} className="active:scale-90 transition-transform">
