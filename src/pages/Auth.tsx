      ...
      <Card className="w-full max-w-sm shadow-2xl border-0 bg-card/95 backdrop-blur-sm">
        ...
        <CardContent>
          <form onSubmit={handleAuth} className="space-y-4">
            ...
            {!resetMode && (<div className="space-y-2"><Label htmlFor="password">{t("auth.passwordLabel")}</Label><PasswordInput id="password" value={password} onChange={(e) => setPassword(e.target.value)} required minLength={6} placeholder="••••••" /></div>)}
